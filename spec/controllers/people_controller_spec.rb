...
describe PeopleController do
  ...
  describe "for subdomain,invalid secret and people id parameters" do
  ...
  describe "for subdomain, secret and invalid people id parameters" do
  ...
  describe "for GET request with valid subdomain,secret and people id parameters" do
  ...
  describe "for POST request with valid subdomain,secret and people id parameters" do
    it "should be request has succeeded" do
